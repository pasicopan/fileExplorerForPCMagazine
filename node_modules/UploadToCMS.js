                ...
                if(a_article.html){
                    for(var a_HTML in a_article.html){
                        ...
                        if('zip' == a_article.html[a_HTML].type){
                            if(fs.existsSync(a_article.title+'/'+a_HTML+'.zip')){
                                ...
                                console.log('scanHTMLZip, waiting4upload:',a_article.title+'/'+a_HTML+'.zip');
                            }else{
                                console.error('can not find:',a_article.title+'/'+a_HTML+'.zip, please zip it before upload.');
                            }
                        }
                    }
                }
